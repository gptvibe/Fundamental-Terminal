    ...
    return CompanyChartsDashboardResponse(
        ...
        summary=CompanyChartsSummaryPayload(
            ...
            unavailable_notes=[
                ...
                "Forecast reliability is heuristic and not a statistical confidence measure.",
            ],
        ),
        ...
        forecast_methodology=CompanyChartsMethodologyPayload(
            ...
            summary="Forecasts use persisted historical official inputs, guarded trend extrapolation, bounded margin assumptions, and a separate heuristic reliability score.",
            disclaimer="Forecast reliability is heuristic, based on filing history depth and input quality, and is not a probability or statistical confidence measure.",
        ),
