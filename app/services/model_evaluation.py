...
from app.models import Company, EarningsModelPoint, FinancialStatement, ModelEvaluationRun, PriceHistory
...
def _serialize_metrics(metrics: dict[str, Any], deltas: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    for model_name in normalize_requested_models(metrics.keys() or None):
