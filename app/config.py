...
class Settings:
    ...
    worker_max_concurrent_jobs: int = field(default_factory=lambda: _int_env("WORKER_MAX_CONCURRENT_JOBS", 1, minimum=1))
    sec_max_concurrent_fetches: int = field(default_factory=lambda: _int_env("SEC_MAX_CONCURRENT_FETCHES", 2, minimum=1))
    market_max_concurrent_fetches: int = field(default_factory=lambda: _int_env("MARKET_MAX_CONCURRENT_FETCHES", 1, minimum=1))
