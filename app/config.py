...
class Settings:
    ...
    db_pool_size: int = _int_env("DB_POOL_SIZE", 20, minimum=1)
    db_max_overflow: int = _int_env("DB_MAX_OVERFLOW", 40, minimum=0)
    ...
    refresh_queue_poll_seconds: float = _float_env("REFRESH_QUEUE_POLL_SECONDS", 5.0, minimum=0.1)
